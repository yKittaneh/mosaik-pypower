...
def test_update_chache(ppc_eidmap):
    ...
    assert cache == {
        ...
        'Trafo1': {'P_from': 1230925.2, 'P_to': -1230920.2, 'Q_from': 441485.7, 'Q_to': -441294.9},
        'B_0': {'P_from': 4621.4, 'P_to': -4615.1, 'Q_from': -288258.8, 'Q_to': -177305.5},
        'B_1': {'P_from': -533701.1, 'P_to': 534055.2, 'Q_from': -220446.3, 'Q_to': -58815.9},
        'B_2': {'P_from': -595384.9, 'P_to': 595676.0, 'Q_from': -22694.5, 'Q_to': -163414.9},
        'B_3': {'P_from': 1445944.8, 'P_to': -1445676.0, 'Q_from': 338815.9, 'Q_to': -366585.1},
    }
